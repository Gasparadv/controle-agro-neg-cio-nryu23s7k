...
export const fallbackData: Record<string, any[]> = {
  ...
  import_batches: [
    ...
    {
      id: 'batch-pending-1',
      date: '2024-05-01T14:20:00.000Z',
      fileName: 'planilha_despesas_maio.xlsx',
      recordCount: 3,
      transactions: [
        {
          id: 'imp-pending-1',
          ...
          category: 'Insumos',
          crop: 'Milho',
          comments: 'Integrar ao fluxo de caixa',
          status: 'pending',
          importBatchId: 'batch-pending-1',
        },
        {
          id: 'imp-pending-2',
          date: '2024-05-03',
          description: 'Combustível Trator',
          amount: -2500,
          type: 'despesa',
          category: 'Combustível',
          crop: 'Geral',
